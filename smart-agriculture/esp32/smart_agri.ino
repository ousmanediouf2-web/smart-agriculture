...
#define PUMP_RELAY_PIN    26   // Relais pompe (LOW = actif)
#define LED_STATUS_PIN    2    // LED intégrée ESP32

// ===== PARAMÈTRES =====
#define DHT_TYPE          DHT11
#define SEND_INTERVAL     30000   // Envoi données toutes les 30 secondes
...
void setup() {
  ...
  digitalWrite(PUMP_RELAY_PIN, HIGH);  // Pompe éteinte (relais actif LOW)
...
void setPump(bool state) {
  pumpState = state;
  digitalWrite(PUMP_RELAY_PIN, state ? LOW : HIGH);  // Relais: LOW = actif
