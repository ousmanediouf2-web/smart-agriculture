...
import { getAlertTypeLabel } from '../../utils/status';
                  ...
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                        ...
                        <span className="text-xs" style={S.text3}>{getAlertTypeLabel(alert.type)}</span>
                        {alert.smsSent && <span className="text-xs" style={{ color: '#059669' }}>📱 Telegram ✓</span>}
