                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs" style={S.text3}>{parcel.cropId?.label || parcel.cropType} • {getParcelStatusLabel(parcel.status)}</p>
                      <p className="text-xs" style={S.text3}>{parcel.sensorCount ?? 0} capteur(s)</p>
