...
import { Plus, Cpu, Wifi, WifiOff, Trash2, X, Save, Loader, AlertCircle } from 'lucide-react';
      ...
      {sensors.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {sensors.map(sensor => {
            ...
            return (
              <div key={sensor._id} className="card card-hover fade-up">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button onClick={() => handleDelete(sensor._id)}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs" style={{ color: 'var(--f-text3)' }}>
                      Mode: <span style={{ color: 'var(--f-text)', fontWeight: 600 }}>{sensor.pumpMode}</span>
                    </p>
                    {sensor.lastSeen && (
                      <p className="text-xs" style={{ color: 'var(--f-text3)' }}>
                        {format(new Date(sensor.lastSeen), 'dd/MM HH:mm', { locale: fr })}
                      </p>
                    )}
                  </div>
                  <div className="flex items-center gap-2">
