      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl w-full max-w-md p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 mt-1">📱 Format international requis pour WhatsApp</p>
          </div>
          <div>
          ...
          <div>
            <label className="label mb-2">Notifications WhatsApp</label>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          {u.phone ? (
                            ...
                            <span className="text-xs text-gray-600">Pas de numéro WhatsApp</span>
                          )}
                        </div>
                        {u.lastLogin && (
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {alert.smsSent && <span className="badge bg-green-900/20 text-green-500 text-xs">📱 WhatsApp ✓</span>}
                      </div>
